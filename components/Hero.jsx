  ...
  return (
    ...
    >
      ...
      <div className="relative mx-auto max-w-6xl px-4 pb-24 pt-24 sm:px-6 sm:pb-32 sm:pt-32 md:pb-40 md:pt-40">
        <div className="mb-6 flex items-center gap-3 font-mono text-xs uppercase tracking-widest text-chalk-muted">
        ...
        <h1 className="font-display text-5xl font-medium leading-[0.95] tracking-tighter text-chalk sm:text-6xl md:text-7xl lg:text-[5.5rem]">
          ...
          <br />
          <span className="text-neon">{content.headline.accent}</span>
        </h1>
        ...
        <div className="mt-12 flex flex-wrap items-center gap-x-6 gap-y-3 font-mono text-xs uppercase tracking-widest text-chalk-dim">
          <a
            href="#work"
